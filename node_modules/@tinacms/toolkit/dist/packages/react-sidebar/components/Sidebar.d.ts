...
export declare function SidebarProvider({ position, defaultWidth, sidebar, }: SidebarProviderProps): JSX.Element;
export declare const updateBodyDisplacement: ({ displayState, sidebarWidth, resizingSidebar, }: {
    displayState: any;
    sidebarWidth: any;
    resizingSidebar: any;
}) => void;
