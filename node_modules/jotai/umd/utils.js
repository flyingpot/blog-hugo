(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jotai = {}, global.react, global.jotai));
  ...
  function useUpdateAtom(anAtom, scope) {
    ...
    var setAtom = react.useCallback(function (update) {
      var write = function write(version) {
        return store[WRITE_ATOM](anAtom, update, version);
      };
  ...
  function createJSONStorage(getStringStorage) {
    ...
    return {
      ...
      removeItem: function removeItem(key) {
        var _getStringStorage$rem, _getStringStorage;

        return (_getStringStorage$rem = (_getStringStorage = getStringStorage()).removeItem) == null ? void 0 : _getStringStorage$rem.call(_getStringStorage, key);
      }
    };
  }
  ...
  function atomWithStorage(key, initialValue, storage) {
    ...
    var anAtom = jotai.atom(function (get) {
      ...
      if (update === RESET) {
        ...
        return storage.removeItem == null ? void 0 : storage.removeItem(key);
      }
