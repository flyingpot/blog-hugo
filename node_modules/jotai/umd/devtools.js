(function (global, factory) {
  ...
  var getDevtoolsState = function getDevtoolsState(atomsSnapshot) {
    var values = {};
    atomsSnapshot[0].forEach(function (v, atom) {
      values[atomToPrintable(atom)] = v;
    });
    var dependents = {};
    atomsSnapshot[1].forEach(function (d, atom) {
  ...
  function useAtomsDevtools(name, scope) {
    var ScopeContext = jotai.SECRET_INTERNAL_getScopeContext(scope);
    ...
    var goToSnapshot = react.useCallback(function (values) {
      if (versionedWrite) {
