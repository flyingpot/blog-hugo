(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jotai = {}, global.core, global.jotai, global.wonka));
  ...
  function atomWithQuery(createQueryArgs, getClient) {
    ...
    var createResultAtom = function createResultAtom(ref, client, args, opts) {
      var resolve = null;
      ...
      resultAtom.onMount = function (update) {
        ...
        var subscription = wonka.pipe(client.query(args.query, args.variables, _extends({}, args.requestPolicy && {
          requestPolicy: args.requestPolicy
        }, args.context, opts)), wonka.skip(1), wonka.subscribe(listener));
        return function () {
    ...
    var queryResultAtom = jotai.atom(function (get) {
      ...
      var resultAtom = createResultAtom(get(refAtom), client, args);
      return {
        ...
        case 'reexecute':
          {
            ...
            set(overwrittenResultAtom, {
              ...
              newResultAtom: createResultAtom(get(refAtom), client, args, action.opts)
            });
          }
      }
    });
