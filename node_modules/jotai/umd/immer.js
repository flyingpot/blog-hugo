(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jotai = {}, global.immer, global.jotai, global.react));
  ...
  function useImmerAtom(anAtom, scope) {
    ...
    var setStateWithImmer = react.useCallback(function (fn) {
      return setState(immer.produce(function (draft) {
        return fn(draft);
      }));
    }, [setState]);
